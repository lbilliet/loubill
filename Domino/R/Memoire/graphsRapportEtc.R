...
plot_date<-smoothScatter(df_date$dateCreated, df_date$nPosts, nrpoints = 2000, colramp = colorRampPalette(c("white", blues9, "red")), xlab = "Date de création", ylab = "Nombre de posts", main = "Effectifs des posts selon leur date de création")
