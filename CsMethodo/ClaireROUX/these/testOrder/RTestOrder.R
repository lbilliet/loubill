...
library("magrittr")
library(readr)
Rall <- read_csv("e:/Lou/Google Drive/médecine/INTERNAT/Cs méthodo/Claire Roux - vems IgG muco/R/thèse/pisteVinc/Rall.csv", 
...
write.csv(dataChrono,file="RallChrono.csv")
